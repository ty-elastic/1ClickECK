...
curl --insecure -XPUT "https://elastic:$kibana_password@$k2.bc.googleusercontent.com:9200/_snapshot/found-snapshots" -H "kbn-xsrf: reporting" -H "Content-Type: application/json" -d'
{
  "type": "gcs",
  "settings": {
    "bucket": "'$bucketname'"
